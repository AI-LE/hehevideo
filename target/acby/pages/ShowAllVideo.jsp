...
<div class="video-container">
    <!--two choices for style:  vjs-default-skin or vjs-sublime-skin-->asdasdf
    <video id=example-video  class="video-js mobile-first-skin" controls preload="auto" width="360" height="640" crossorigin="anonymous">
        <source src="<%= basePath%>/demo/videol.mp4"
                type="video/mp4">
        <!-- <source src="http://staticresource.console.ksyun.com/kmc/video/fangdou_720p.mp4"
                type="video/mp4"> -->
    </video>
</div>
...
<script>
    ...
    ksplayer.options.flash.swf = "video.mp4";
